    ...
    <>
      <Card className="card-block card-stretch card-height">
        <Card.Body>
                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    <div className="user-profile-info d-flex justify-content-center flex-column g-0">
                      ...
                      <p className="mb-0 mt-n1 text-gray" style={{fontSize: 14, fontWeight: '400'}}>
          ...
          <div className="mt-2">
            <div className="m-0 mb-2 text-capitalize text-dark elipsis-1" dangerouslySetInnerHTML={{ __html: post.title }} />
            <div className="text-dark text-capitalize elipsis-4" dangerouslySetInnerHTML={{ __html: post.description }} style={{fontSize: '14px', lineHeight: '1.5'}} />
          </div>
              ...
              <div className="like-block d-flex align-items-center">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M12.62 20.81C12.28 20.93 11.72 20.93 11.38 20.81C8.48 19.82 2 15.69 2 8.68998C2 5.59998 4.49 3.09998 7.56 3.09998C9.38 3.09998 10.99 3.97998 12 5.33998C13.01 3.97998 14.63 3.09998 16.44 3.09998C19.51 3.09998 22 5.59998 22 8.68998C22 15.69 15.52 19.82 12.62 20.81Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </button>
