...
import business_img_1 from "../../../assets/images/page-img/bussiness(4).jpg";
import business_img_2 from "../../../assets/images/page-img/bussiness(5).jpg";
import business_img_3 from "../../../assets/images/page-img/bussiness(6).jpg";
import business_img_4 from "../../../assets/images/page-img/bussiness(8).jpg";
import business_img_5 from "../../../assets/images/page-img/bussiness(9).jpg";
              ...
              <div className="user-post mt-4">
                <div className="row">
                  <div className="col-md-4">
                    <a
                      ...
                      href="{{URL::asset('/images/bussiness(5).jpg')}}"
                      className="rounded"
                    >
                      <img
                        src={business_img_1}
                  ...
                  <div className="col-md-4 mt-md-0 mt-3">
                    <a
                      data-fslightbox="gallery"
                      href="{{URL::asset('/images/bussiness(6).jpg')}}"
                      className="rounded"
                    >
                      <img
                        src={business_img_2}
                  ...
                  <div className="col-md-4 mt-md-0 mt-3">
                    <a
                      data-fslightbox="gallery"
                      href="{{URL::asset('/images/bussiness(8).jpg')}}"
                      className="rounded"
                    >
                      <img
                         src={business_img_3}
                ...
                <div className="row mt-3">
                  <div className="col-md-6">
                    <a
                      data-fslightbox="gallery"
                      href="{{URL::asset('/images/bussiness(9).jpg')}}"
                      className="rounded"
                    >
                      <img
                         src={business_img_4}
                  ...
                  <div className="col-md-6 mt-md-0 mt-3">
                    <div className="post-overlay-box h-100 rounded">
                      ...
                      <a
                        data-fslightbox="gallery"
                        href="{{URL::asset('/images/bussiness(4).jpg')}}"
            ...
            <div className="card-body">
              ...
              <div className="user-post mt-4">
                <div className="ratio ratio-16x9">
                  <iframe
                    src="https://www.youtube.com/embed/HE9JioDuXkQ"
                    allowFullScreen=""
                  />
                </div>
              </div>
          ...
          <div className="card-body">
            ...
            <div className="user-post mt-4">
              <div className="text-center">
                <img
                  src="{{ asset('/images/bussiness(1).jpg') }}"
                  alt="ads"
                  className="img-fluid"
                />
                <a
