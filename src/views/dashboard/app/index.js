        ...
        <div className={styles['image-div']}>
          <div className={styles['image-wrapper']}>
            ...
            <div className={styles.links}>
              <a href="/business" className={`${styles['link-item']} ${styles.laptop}`}>
                <span className={styles.tooltip}>Branded Laptops</span>
              </a>
              <a href="/crypto" className={`${styles['link-item']} ${styles.cap}`}>
                <span className={styles.tooltip}>Latest Design Caps</span>
              </a>
              <a href="/fitness" className={`${styles['link-item']} ${styles.shoes}`}>
                <span className={styles.tooltip}>Branded Shoes</span>
              </a>
              <a href="/mindset" className={`${styles['link-item']} ${styles.cap2}`}>
