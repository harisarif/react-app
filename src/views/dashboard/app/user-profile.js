...
const UserProfile = () => {
  ...
  const tabs = [
    { key: 'tab1', label: 'Tab 1', content: 'This is the content of Tab 1' },
    { key: 'tab2', label: 'Tab 2', content: 'This is the content of Tab 2' },
    { key: 'tab3', label: 'Tab 3', content: 'This is the content of Tab 3' },
  ];
      ...
      <div id="content-page" className="content-inner m-0">
        ...
        <Card className='border radius-12 profile-main-card'>
          ...
          <Card.Body className='profile-div-footer border-top'>
            <Nav
              variant="pills"
              className="flex-row m-0 gap-3"
              activeKey={activeKey}
              onSelect={(selectedKey) => setActiveKey(selectedKey)}
            >
              {tabs.map((tab) => (
                <Nav.Item key={tab.key}>
                  <Nav.Link className='px-0' eventKey={tab.key}>{tab.label}</Nav.Link>
                </Nav.Item>
              ))}
            </Nav>
          </Card.Body>
