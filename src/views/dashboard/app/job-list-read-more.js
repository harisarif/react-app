        ...
        <div className="col-md-7 col-lg-7 overflow-hidden position-relative d-none d-md-block find-more-left-side">
          <div className="main-inner-wrapper">
            ...
            <span className="find-more-span ">
              ...
              and be a strategic genius.
            </span>
            <br />
            <br />
            <span className="find-more-span">
              Whether you're taking on a new role as a CLO or an existing one,
              we take you through how to create a comprehensive strategy that
              aligns with your organization's and team's objectives and targets.
            </span>
            <h4 className="find-more-ul-heading mt-4">In this guide you’ll:</h4>
            <ul className="find-more-ul mt-3">
              <li>Learn the vital steps to complete as a CLO</li>
              <li>Understand what a 90-day plan is and how to create one</li>
              <li>
                Know where to find the top L&amp;D resources and useful tools
                for success
              </li>
              <li>
...
export default JobListReadMore;
