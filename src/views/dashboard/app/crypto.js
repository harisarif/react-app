...
import crypto_img_1 from "../../../assets/images/page-img/crypto(1).jpg";
import crypto_img_2 from "../../../assets/images/page-img/crypto(2).jpg";
import crypto_img_3 from "../../../assets/images/page-img/crypto(3).jpg";
import crypto_img_4 from "../../../assets/images/page-img/crypto(5).jpg";
import crypto_img_5 from "../../../assets/images/page-img/crypto(6).jpg";
              ...
              <div className="user-post mt-4">
                <div className="row">
                  <div className="col-md-4">
                    <a
                      ...
                      href="{{URL::asset('/images/crypto(1).jpg')}}"
                      className="rounded"
                    >
                      <img
                        src={crypto_img_1}
                  ...
                  <div className="col-md-4 mt-md-0 mt-3">
                    <a
                      data-fslightbox="gallery"
                      href="{{URL::asset('/images/crypto(2).jpg')}}"
                      className="rounded"
                    >
                      <img
                        src={crypto_img_2}
                  ...
                  <div className="col-md-4 mt-md-0 mt-3">
                    <a
                      data-fslightbox="gallery"
                      href="{{URL::asset('/images/crypto(3).jpg')}}"
                      className="rounded"
                    >
                      <img
                       src={crypto_img_3}
                ...
                <div className="row mt-3">
                  <div className="col-md-6">
                    <a
                      data-fslightbox="gallery"
                      href="{{URL::asset('/images/crypto(5).jpg')}}"
                      className="rounded"
                    >
                      <img
                        src={crypto_img_5}
                  ...
                  <div className="col-md-6 mt-md-0 mt-3">
                    <div className="post-overlay-box h-100 rounded">
                      ...
                      <a
                        data-fslightbox="gallery"
                        href="{{URL::asset('/images/crypto(6).jpg')}}"
            ...
            <div className="card-body">
              ...
              <div className="user-post mt-4">
                <div className="ratio ratio-16x9">
                  <iframe
                    src="https://www.youtube.com/embed/Yga3BUjqRME"
                    allowFullScreen=""
                  />
                </div>
              </div>
