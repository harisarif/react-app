                    ...
                    <Col lg="12">
                      <div className="table-responsive">
                        <table className="table table-invoice">
                          <thead>
                            <tr>
                              <th scope="col align-baseline">Order Date</th>
                              <th scope="col align-baseline">Order Status</th>
                              <th scope="col align-baseline">Order ID</th>
                              <th scope="col align-baseline">Billing Address</th>
                              <th scope="col align-baseline">Shipping Address</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
